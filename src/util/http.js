...
export const updateExpenseInDb = (id, expenseData)=>{
    axios.put(BACKEND__URL+`expenses/${id}.json`, expenseData);
}
export const deleteExpenseIFromDb = (id, expenseData)=>{
    axios.delete(BACKEND__URL+`expenses/${id}.json`, expenseData);
}